	    ...
	    public void actionPerformed(ActionEvent e) {
	    	try { switch (accion) {
	    			case "UpArrow":		//System.out.println("The up arrow was pressed!");
	    					juego.realizarJugadaEnDireccion(norte); break;
	    			case "DownArrow":	//System.out.println("The down arrow was pressed!");
	    					juego.realizarJugadaEnDireccion(sur); break;
	    			case "LeftArrow":	//System.out.println("The left arrow was pressed!");
	    					juego.realizarJugadaEnDireccion(oeste); break;
	    			case "RightArrow":	//System.out.println("The right arrow was pressed!");
	    					juego.realizarJugadaEnDireccion(este); break;	} 
	    		}	catch (MovimientoInvalidoExcepcion ex) {panelPartida.mostrarMensajeMovimientoInvalido();}; }
	    }

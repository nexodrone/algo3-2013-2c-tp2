...
public class EditorDeNiveles {
	...
	public static void crearNivelIntermedio() throws Exception{
		...
		nivel.tablero.getBocacalleEnPosicion(new Posicion(0,6)).getCalleEnDireccion(este).setSorpresa(new SorpresaCambioDeVehiculo());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(5,10)).getCalleEnDireccion(oeste).setSorpresa(new SorpresaCambioDeVehiculo());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(13,9)).getCalleEnDireccion(oeste).setSorpresa(new SorpresaCambioDeVehiculo());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(11,10)).getCalleEnDireccion(este).setSorpresa(new SorpresaCambioDeVehiculo());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(5,8)).getCalleEnDireccion(oeste).setSorpresa(new SorpresaCambioDeVehiculo());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(1,2)).getCalleEnDireccion(este).setObstaculo(new ObstaculoPozo());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(9,5)).getCalleEnDireccion(este).setObstaculo(new ObstaculoPozo());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(8,0)).getCalleEnDireccion(oeste).setObstaculo(new ObstaculoPozo());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(10,0)).getCalleEnDireccion(este).setObstaculo(new ObstaculoPozo());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(12,0)).getCalleEnDireccion(este).setObstaculo(new ObstaculoPozo());
	...
	public static void crearNivelDificil() throws Exception{
		...
		nivel.tablero.getBocacalleEnPosicion(new Posicion(6,1)).getCalleEnDireccion(este).setObstaculo(new ObstaculoPozo());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(1,1)).getCalleEnDireccion(este).setObstaculo(new ObstaculoPozo());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(3,3)).getCalleEnDireccion(este).setObstaculo(new ObstaculoPozo());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(7,9)).getCalleEnDireccion(este).setObstaculo(new ObstaculoPozo());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(13,10)).getCalleEnDireccion(este).setObstaculo(new ObstaculoPozo());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(8,7)).getCalleEnDireccion(este).setObstaculo(new ObstaculoPozo());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(15,11)).getCalleEnDireccion(este).setObstaculo(new ObstaculoPozo());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(1,11)).getCalleEnDireccion(este).setObstaculo(new ObstaculoPozo());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(0,6)).getCalleEnDireccion(este).setObstaculo(new ObstaculoPozo());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(1,6)).getCalleEnDireccion(este).setSorpresa(new SorpresaDesfavorable());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(0,2)).getCalleEnDireccion(este).setSorpresa(new SorpresaDesfavorable());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(5,6)).getCalleEnDireccion(este).setSorpresa(new SorpresaDesfavorable());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(1,8)).getCalleEnDireccion(este).setSorpresa(new SorpresaDesfavorable());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(11,3)).getCalleEnDireccion(este).setSorpresa(new SorpresaDesfavorable());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(12,7)).getCalleEnDireccion(este).setSorpresa(new SorpresaDesfavorable());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(9,8)).getCalleEnDireccion(este).setSorpresa(new SorpresaDesfavorable());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(6,11)).getCalleEnDireccion(este).setSorpresa(new SorpresaDesfavorable());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(17,7)).getCalleEnDireccion(este).setSorpresa(new SorpresaDesfavorable());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(11,11)).getCalleEnDireccion(este).setSorpresa(new SorpresaDesfavorable());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(17,3)).getCalleEnDireccion(este).setSorpresa(new SorpresaDesfavorable());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(9,5)).getCalleEnDireccion(este).setSorpresa(new SorpresaDesfavorable());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(6,4)).getCalleEnDireccion(este).setSorpresa(new SorpresaDesfavorable());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(11,12)).getCalleEnDireccion(este).setSorpresa(new SorpresaDesfavorable());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(16,1)).getCalleEnDireccion(este).setSorpresa(new SorpresaDesfavorable());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(14,9)).getCalleEnDireccion(este).setSorpresa(new SorpresaDesfavorable());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(4,9)).getCalleEnDireccion(este).setSorpresa(new SorpresaCambioDeVehiculo());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(6,8)).getCalleEnDireccion(este).setSorpresa(new SorpresaCambioDeVehiculo());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(14,6)).getCalleEnDireccion(este).setSorpresa(new SorpresaCambioDeVehiculo());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(15,8)).getCalleEnDireccion(este).setSorpresa(new SorpresaCambioDeVehiculo());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(5,3)).getCalleEnDireccion(este).setSorpresa(new SorpresaCambioDeVehiculo());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(10,7)).getCalleEnDireccion(este).setSorpresa(new SorpresaCambioDeVehiculo());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(5,11)).getCalleEnDireccion(este).setSorpresa(new SorpresaCambioDeVehiculo());
		nivel.tablero.getBocacalleEnPosicion(new Posicion(16,0)).getCalleEnDireccion(este).setSorpresa(new SorpresaCambioDeVehiculo());
